...
#define L2CAP_MPS_CONF                               (1024U)//ZAO 247 to 1024
#define NUM_L2CAP_COCS_CONF                          (1U)//ZAO 0U to 1U
#define MAX_NUM_CTE_ANTENNA_IDS                      (0U)
#define MAX_NUM_CTE_IQ_SAMPLES                       (0U)

#define ISR0_FIFO_SIZE   (256)
#define ISR1_FIFO_SIZE   (768)// ZAO default 768
...
#define NUM_OF_CONCURRENT_GATT_CLIENT_PROC_CONF         (0)//ZAO
